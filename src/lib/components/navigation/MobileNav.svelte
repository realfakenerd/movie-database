<script>
	...
	let dPath = closedDpath;

	function changeSvgMenu() {
		dPath === closedDpath ? (dPath = openDpath) : (dPath = closedDpath);
	}
</script>
...
<div class="navbar-center">
	<div class="btn btn-ghost">
		<a sveltekit:prefetch href="/">
			<svg class="w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 449"
...
<div class="navbar-end">
	<div class="dropdown dropdown-end">
		...
		<label on:click={changeSvgMenu} tabindex="0" class="btn btn-ghost rounded-btn">
			<svg

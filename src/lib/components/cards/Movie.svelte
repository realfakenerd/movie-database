...
<a
	class="group card image-full card-compact transform transition duration-300 ease-out hover:-translate-y-2 hover:shadow-lg hover:shadow-primary/30 w-72 md:w-48 lg:w-52 xl:w-56"
	href={'/movie/' + movie.id}
>
	<figure>

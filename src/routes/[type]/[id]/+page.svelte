			...
			<div class="flex flex-col justify-around items-center w-full">
				<section>
					...
					<div>
						...
						<p class="">base on {movie.vote_count} votes</p>
					</div>
				</section>
				<section>
...
<section id="mainHeroContainer" class="grid grid-cols-1 p-10 md:grid-cols-2">
	<div class="flex flex-col gap-4">
		<h2 class="text-2xl font-semibold">Movie cast</h2>

		{#each movie.credits.cast.slice(0, 14) as cast}
			<div
				class="group rounded-box flex w-1/2 items-center gap-3 p-2 transition-colors duration-300 hover:bg-base-200"
			>
				<div class="avatar">
	...
	<div class="space-y-5">
		...
		<div class="carousel rounded-box space-x-4 bg-neutral p-4">
